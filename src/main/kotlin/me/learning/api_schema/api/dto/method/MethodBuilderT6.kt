...
data class MethodBuilderT6<T1 : Any, T2 : Any, T3 : Any, T4 : Any, T5 : Any, T6 : Any>(
    val route: Route,
    ...
    val p5: Pair<KClass<T5>, RoutePropertyEnum>,
    val p6: Pair<KClass<T6>, RoutePropertyEnum>
) {
    init {
        val properties = listOf(p1.second, p2.second, p3.second, p4.second, p5.second, p6.second)

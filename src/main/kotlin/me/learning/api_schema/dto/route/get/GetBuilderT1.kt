...
data class GetBuilderT1<T1 : Any>(
    val route: Route,
    val path: String,
    ...
    fun <T : Any> addProp(pair: Pair<KClass<T>, RoutePropEnum>): GetBuilderT2<T1, T> =
        GetBuilderT2(
            route,
            path,
            p1,
    ...
    inline fun <reified T : Any> pathVariable(): GetBuilderT2<T1, T> {

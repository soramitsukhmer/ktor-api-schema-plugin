...
inline fun <reified T> Route.GET(
    ...
    return this.get(path.cleanRoutePath(), schemaBuilder<T, Unit>(responseWrapper = responseWrapper)) {
...
inline fun <reified T,
    ...
    val builder = when (true) {
        isRequestBody<T1>() -> schemaBuilder<T, V1>(prop.pathVariable, responseWrapper)
        isRequestBody<T2>() -> schemaBuilder<T, V2>(prop.pathVariable, responseWrapper)
        else -> schemaBuilder<T, Unit>(prop.pathVariable, responseWrapper)
    }
...
inline fun <reified T,
    ...
    val builder = when (true) {
        isRequestBody<T1>() -> schemaBuilder<T, V1>(prop.pathVariable, responseWrapper)
        isRequestBody<T2>() -> schemaBuilder<T, V2>(prop.pathVariable, responseWrapper)
        isRequestBody<T3>() -> schemaBuilder<T, V3>(prop.pathVariable, responseWrapper)
        else -> schemaBuilder<T, Unit>(prop.pathVariable, responseWrapper)
    }
...
inline fun <reified T,
    ...
    val builder = when (true) {
        ...
        isRequestBody<T2>() -> schemaBuilder<T, V2>(prop.pathVariable, responseWrapper)
        isRequestBody<T3>() -> schemaBuilder<T, V3>(prop.pathVariable, responseWrapper)
        isRequestBody<T4>() -> schemaBuilder<T, V4>(prop.pathVariable, responseWrapper)
        else -> schemaBuilder<T, Unit>(prop.pathVariable, responseWrapper)
    }
...
inline fun <reified T,
    ...
    val builder = when (true) {
        ...
        isRequestBody<T3>() -> schemaBuilder<T, V3>(prop.pathVariable, responseWrapper)
        isRequestBody<T4>() -> schemaBuilder<T, V4>(prop.pathVariable, responseWrapper)
        isRequestBody<T5>() -> schemaBuilder<T, V5>(prop.pathVariable, responseWrapper)
        else -> schemaBuilder<T, Unit>(prop.pathVariable, responseWrapper)
    }

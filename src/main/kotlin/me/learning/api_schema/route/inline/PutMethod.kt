...
inline fun <reified T> Route.put(
    ...
    return this.put(path.cleanRoutePath(), schemaBuilder<T, Unit>(hidden, responseWrapper = responseWrapper)) {
...
inline fun <reified T, reified V1 : Any, reified T1 : RouteProp<V1>> Route.put(
    ...
    val builder = when (true) {
        ...
        else -> schemaBuilder<T, V1>(hidden, prop.pathVariable, responseWrapper = responseWrapper)
    }
...
inline fun <reified T,
        ...
        > Route.put(path: String = "", responseWrapper: Boolean = true, hidden: Boolean = false, crossinline block: suspend RoutingRequest.(T1, T2) -> T
): Route {
    ...
    val builder = when (true) {
        ...
        else -> schemaBuilder<T, V2>(hidden, prop.pathVariable, responseWrapper = responseWrapper)
    }
...
inline fun <reified T,
        ...
        > Route.put(path: String = "", responseWrapper: Boolean = true, hidden: Boolean = false, crossinline block: suspend RoutingRequest.(T1, T2, T3) -> T
): Route {
    val collection = listOf(
        V1::class to T1::class,
        V2::class to T2::class,
    ...
    val builder = when (true) {
        ...
        else -> schemaBuilder<T, V3>(hidden, prop.pathVariable, responseWrapper = responseWrapper)
    }
...
inline fun <reified T,
        ...
        > Route.put(path: String = "", responseWrapper: Boolean = true, hidden: Boolean = false, crossinline block: suspend RoutingRequest.(T1, T2, T3, T4) -> T
): Route {
...
inline fun <reified T,
        ...
        > Route.put(path: String = "", responseWrapper: Boolean = true, hidden: Boolean = false, crossinline block: suspend RoutingRequest.(T1, T2, T3, T4, T5) -> T
): Route {
    val collection = listOf(
        V1::class to T1::class,
        V2::class to T2::class,
